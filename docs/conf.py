# -*- coding: utf-8 -*-
#
# pylapsy documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'pylapsy.tex', u'pylapsy Documentation',
...
man_pages = [
    (master_doc, 'pylapsy', u'pylapsy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pylapsy', u'pylapsy Documentation',
   author, 'pylapsy', 'One line description of project.',
   'Miscellaneous'),
]
